...
export const translations = {
  uz: {
    ...
    aboutP1:
      "Salom! Men Bekzod Qosimov — turk tilini o‘rgatishga ixtisoslashgan ustozman. 5 yillik ta’lim tajribam davomida dunyoning turli mamlakatlaridan yuzlab o‘quvchilarga turk tili va uning madaniyatini chuqurroq tushunishga hamda amalda qo‘llashga yordam berib kelmoqdaman.",
    aboutP2:
      "Mening o'qitish falsafam o'quvchilar xatolarini qilishda o'zlarini qulay his qiladigan va yutuqlarni nishonlaydigan qiziqarli va qo'llab-quvvatlovchi muhit yaratishga qaratilgan. Men til o'rganish amaliy, qiziqarli va real hayot vaziyatlari bilan chambarchas bog'liq bo'lishi kerak deb hisoblayman.",
    aboutP3:
      "Sayohat, biznes yoki shaxsiy rivojlanish uchun turk tilini o'rganyapsizmi, men sizning maqsad va o'rganish uslubingizga moslashtirilgan shaxsiy darslar bilan siz ravonlikka erishishingizda yo'l ko'rsataman.",

    // Courses Section
    coursesTitle: "Turk tili kurslari",
    beginnerTitle: "Boshlang'ich",
    beginnerDesc:
      "Turk tiliga noldan boshlang. Asosiy salomlashishlar, muhim lug'at va kundalik muloqot uchun asosiy grammatika tuzilmalarini o'rganing.",
    beginnerDuration: "Davomiyligi: 1 oy",
    beginnerFrequency: "Haftada 3 mashg'ulot",
    intermediateTitle: "O'rta",
    intermediateDesc:
      "Turk tili ko'nikmalaringizni yanada murakkab grammatika, idiomatik iboralar va kengroq mavzularni ishonch bilan muhokama qilish uchun suhbat amaliyoti bilan kengaytiring.",
    intermediateDuration: "Davomiyligi: 2 oy",
    intermediateFrequency: "Haftada 3 mashg'ulot",
    advancedTitle: "Yuqori",
    advancedDesc:
      "Turk tilini yuqori darajada o'zlashtiring. Talaffuzingizni mukammallashtiring, adabiyotni o'rganing va murakkab mavzularda ona tilida so'zlashuvchi kabi chuqur muhokamalar olib boring.",
    ...
    socialDesc:
      "Turk tilini o'rganuvchilarning o'sib borayotgan jamoasiga qo'shiling! Kundalik darslar, madaniy tushunchalar va motivatsion kontent uchun meni ijtimoiy tarmoqlarda kuzatib boring.",
    instagramHandle: "@bekzod_hoca",
    instagramDesc: "Kundalik turk maslahatlar, lug'at va madaniy hikoyalar",
    telegramHandle: "@Turktili_Fergana",
    telegramDesc: "Eksklyuziv kontent, jonli seanslar va talabalar jamoasi",
    ...
    locationOnlineDesc:
      "Shaxsan kela olmaysizmi? Men butun dunyo bo'ylab talabalar uchun moslashuvchan jadval bilan Zoom orqali interaktiv onlayn darslar taklif qilaman.",

    // Contact Section
    contactTitle: "Bog'lanish",
    contactDesc:
      "Turk tilini o'rganish sayohatingizni boshlashga tayyormisiz? Menga xabar yuboring, tez orada sizga javob beraman!",
    nameLabel: "Ism",
    namePlaceholder: "To'liq ismingiz",
    phoneLabel: "Telefon",
    phonePlaceholder: "+998 XX XXX XX XX",
    messageLabel: "Xabar",
    messagePlaceholder: "Turk tilini o'rganish maqsadlaringiz haqida gapirib bering...",
    sendButton: "Xabar yuborish",
    sendingButton: "Yuborilmoqda...",
    successMessage: "Xabaringiz muvaffaqiyatli yuborildi! Tez orada aloqaga chiqamiz.",
